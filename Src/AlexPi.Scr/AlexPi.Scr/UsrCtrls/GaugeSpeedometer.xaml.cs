...
namespace AAV.SS.UsrCtrls
{
  public partial class GaugeSpeedometer : UserControl
  {
    ...
    public static readonly DependencyProperty GaugeTextProperty = DependencyProperty.Register("GaugeText", typeof(string), typeof(GaugeSpeedometer), new UIPropertyMetadata("...")); public string GaugeText { get { return (string)GetValue(GaugeTextProperty); } set { SetValue(GaugeTextProperty, value); } }
    public static readonly DependencyProperty GaugeNameProperty = DependencyProperty.Register("GaugeName", typeof(string), typeof(GaugeSpeedometer), new UIPropertyMetadata("...")); public string GaugeName { get { return (string)GetValue(GaugeNameProperty); } set { SetValue(GaugeNameProperty, value); } }
    public static readonly DependencyProperty MiddlValProperty = DependencyProperty.Register("MiddlVal", typeof(double), typeof(GaugeSpeedometer), new UIPropertyMetadata(_ang0)); public double MiddlVal { get { return (double)GetValue(MiddlValProperty); } set { SetValue(MiddlValProperty, value); } }
    public static readonly DependencyProperty OuterValProperty = DependencyProperty.Register("OuterVal", typeof(double), typeof(GaugeSpeedometer), new UIPropertyMetadata(_ang0)); public double OuterVal { get { return (double)GetValue(OuterValProperty); } set { SetValue(OuterValProperty, value); } }
    public static readonly DependencyProperty InnerValProperty = DependencyProperty.Register("InnerVal", typeof(double), typeof(GaugeSpeedometer), new UIPropertyMetadata(_ang0)); public double InnerVal { get { return (double)GetValue(InnerValProperty); } set { SetValue(InnerValProperty, value); } }
    public static readonly DependencyProperty MiddlValAnimProperty = DependencyProperty.Register("MiddlValAnim", typeof(double), typeof(GaugeSpeedometer), new UIPropertyMetadata(_ang0, new PropertyChangedCallback(onMiddlValChngd))); public double MiddlValAnim { get { return (double)GetValue(MiddlValAnimProperty); } set { SetValue(MiddlValAnimProperty, value); } }
    ...
    public static readonly DependencyProperty InnerValAnimProperty = DependencyProperty.Register("InnerValAnim", typeof(double), typeof(GaugeSpeedometer), new UIPropertyMetadata(_ang0, new PropertyChangedCallback(onInnerValChngd))); public double InnerValAnim { get { return (double)GetValue(InnerValAnimProperty); } set { SetValue(InnerValAnimProperty, value); } }
