...
public partial class CpuHistogram : UserControl
{
  ...
  public CpuHistogram()
  {
    ...
    for (var i = 0; i < _dbg; i++) _ = sp1.Children.Add(new Rectangle());
  ...
  void dov(StackPanel stkPnl, double percCpuLoad)
  {
    ...
    _ = stkPnl.Children.Add(new Rectangle { Height = Math.Abs(50 * Math.Log10(percCpuLoad) - percCpuLoad), Margin = new Thickness(0, 0, 0, percCpuLoad) });
