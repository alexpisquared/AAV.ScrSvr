...
public partial class SettingsWindow : Window
{
  ...
  {
    AppDomain.CurrentDomain.UnhandledException += new UnhandledExceptionEventHandler((s, e) => { if (e.IsTerminating) _ = System.Windows.MessageBox.Show(e.ExceptionObject.ToString()); });
    ...
    txtPath.Text = AppSettings.Instance.ImgPath != "null" ? AppSettings.Instance.ImgPath : "";
  ...
  {
    _delay = AppSettings.Instance.DelayMin;
    _seconds = _delay == 0 ? 30 : Convert.ToInt32(_delay) * 60;
  }
  ...
  {
    AppSettings.Instance.ImgPath = txtPath.Text == "" ? "null" : txtPath.Text;
