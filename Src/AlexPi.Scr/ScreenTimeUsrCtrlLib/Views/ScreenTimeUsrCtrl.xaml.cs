...
public partial class ScreenTimeUsrCtrl
{
  ...
  public static readonly DependencyProperty ZVProperty = DependencyProperty.Register("ZV", typeof(double), typeof(ScreenTimeUsrCtrl), new PropertyMetadata(2.0)); public double ZV { get => (double)GetValue(ZVProperty); set => SetValue(ZVProperty, value); } // Zoom Value is 2.5 by default .. hardcoded and not saved anywhere (2026-10)
}