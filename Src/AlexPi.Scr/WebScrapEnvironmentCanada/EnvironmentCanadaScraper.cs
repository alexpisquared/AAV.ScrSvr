...
//    static readonly Almanac.NewDataSet dsAlmanac = new EnvironmentCanadaScrap.Almanac.NewDataSet();
...
//    {
//      foreach (var url in Properties.Settings.Default.SiteList.Split('|'))
//      {
